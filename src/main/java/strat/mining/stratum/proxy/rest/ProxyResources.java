...
public class ProxyResources {
    ...
    @ApiResponses({ @ApiResponse(code = 500, message = "Failed to start the pool.", response = StatusDTO.class),
    ...
    @ApiResponses({ @ApiResponse(code = 500, message = "Failed to update the pool.", response = StatusDTO.class),
            @ApiResponse(code = 400, message = "Bad parameter sent.", response = StatusDTO.class),
            @ApiResponse(code = 404, message = "Pool not found.", response = StatusDTO.class) })
